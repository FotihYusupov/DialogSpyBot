...
const premium_guard_1 = require("./guards/premium.guard");
...
exports.PremiumModule = PremiumModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [premium_service_1.PremiumService, premium_guard_1.PremiumGuard],
        exports: [premium_service_1.PremiumService, premium_guard_1.PremiumGuard],
    })
], PremiumModule);
